...
namespace offsets
{
	extern std::vector<uintptr_t> Settings;
	extern std::vector<uintptr_t> CPlayer;
	extern std::vector<uintptr_t> Knife;
	extern std::vector<uintptr_t> WeaponComponent;
	extern std::vector<uintptr_t> CCurrentWeapon2;
	extern std::vector<uintptr_t> CCurrentWeapon3;
	extern std::vector<uintptr_t> CCurrentWeapon4;
	extern std::vector<uintptr_t> CCurrentWeapon5;
	extern std::vector<uintptr_t> CCurrentWeapon6;
	extern std::vector<uintptr_t> CCurrentWeaponCaliber;
	extern std::vector<uintptr_t> LightManager;
	extern std::vector<uintptr_t> ESP;
	extern std::vector<uintptr_t> GodMode;
	extern std::vector<uintptr_t> NoClip;
	extern std::vector<uintptr_t> Camera;
	extern std::vector<uintptr_t> Drone1;
